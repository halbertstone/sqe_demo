...
class TestLoginOpportunity(unittest.TestCase):
    ...
    def test_fill_new_opportunity_form_happy(self):
        ...
        Stubs for handling creation of associated data require
        """
        chrome_options = webdriver.ChromeOptions()
        browser = Browser('chrome', options=chrome_options)
        Utilities.do_npsp_login(browser)
        # Expect the Home Page: Getting Started Tab
        if not browser.is_text_present("Getting Started", 60):
            raise Opportunity_Exception("Getting Started not found")
        waffle_button_list = browser.find_by_css("#oneHeader > div.bBottom > one-appnav > div > div > div > nav")
        waffle_button = Utilities.verify_one_item_list(waffle_button_list)
        waffle_button.click()
    ...
    def test_do_login(self):
        ...
        with browser:
            ...
            while browser.is_element_not_present_by_id(CONST.TWO_FACTOR_ID, 60):
                if browser.is_text_present(browser, CONST.TWO_FACTOR_CANNOT_SEND):
            ...
            # TODO: Ask about reliability of the selector as a repeatable locator; seemed to stop working, using text

            # TODO: uncomment
            # while browser.is_text_present(CONST.HOME_EXPECTED_WELCOME_TEXT, 60):
            #     pass
            ...
            # TODO: this SELECTOR based find stopped working
            ...
            browser.is_text_present(CONST.HOME_EXPECTED_WELCOME_TEXT, 5)
